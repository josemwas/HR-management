...
def create_app(config_name='default'):
    ...
    from app.routes import (auth, employees, attendance, leaves, payroll, recruitment, performance, 
                           ...
                           self_service, compliance, compensation, exit_management, employee_relations,
                           time_labor, workforce_planning, succession_planning)
    ...
    app.register_blueprint(exit_management.exit_management_bp)
    app.register_blueprint(employee_relations.employee_relations_bp)
    app.register_blueprint(time_labor.time_labor_bp)
    app.register_blueprint(workforce_planning.workforce_planning_bp)
    app.register_blueprint(succession_planning.succession_planning_bp)
    ...
    # Additional High-Priority Feature Routes
